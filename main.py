...
def main():
    ...
    try:
        ...
        # os._exit(0) убьёт процесс и все ресурсы будут освобождены ОС
        ...
        # Немедленное завершение процесса без cleanup браузера
        # Закрытие браузера ВНУТРИ with sync_playwright() вызывает блокировку!
        logger.info("🏁 Принудительное завершение процесса (без cleanup браузера)...")
        os._exit(0)
